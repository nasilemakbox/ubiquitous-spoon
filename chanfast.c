...
void chanfast2(int p_row, int p_col,
               ...
               double betg_x, double betg_y, double betg_z)
{
    ...
    for ( ; it < nt; it++) {
        ...
        for (step = 0; step < 3; step++) { // RK3 stepper
            ...
            add_laplacexy_operator_u2(u, fu, local_nx, local_ny, nz,
                                      nghost_x, nghost_y, nghost_z, dx, dy, nu);
            add_laplacexy_operator_u2(v, fv, local_nx, local_ny, nz,
                                      nghost_x, nghost_y, nghost_z, dx, dy, nu);
            add_laplacexy_operator_w2(w, fw, local_nx, local_ny, nz,
                                      nghost_x, nghost_y, nghost_z, dx, dy, nu);
            ...
            add_laplacexy_operator_u2(c, fc, local_nx, local_ny, nz,
                                      nghost_x, nghost_y, nghost_z, dx, dy, nu / prandtl);
            ...
            helmholtz1d_operator_u2(u, h, local_nx, local_ny, nz,
                                    nghost_x, nghost_y, nghost_z, dz, nuadt);
            ...
            apply_bc_u2(bc, local_nx, local_ny, nz, nghost_x, nghost_y, nghost_z,
                        xu, yp, dz, bc_u_bot, bc_u_top, bctype_u_bot, bctype_u_top);
            helmholtz1d_operator_u2(bc, hbc, local_nx, local_ny, nz,
                                    nghost_x, nghost_y, nghost_z, dz, -nubdt);
            for (i = 0; i < local_size; i++) h[i] -= hbc[i];

            solve_helmholtz1d_u2(u, h, local_nx, local_ny, nz,
                                 nghost_x, nghost_y, nghost_z, dz, -nubdt,
            ...
            apply_bc_u2(v, local_nx, local_ny, nz, nghost_x, nghost_y, nghost_z,
                        xp, yv, dz, bc_v_bot, bc_v_top, bctype_v_bot, bctype_v_top);
            helmholtz1d_operator_u2(v, h, local_nx, local_ny, nz,
                                    nghost_x, nghost_y, nghost_z, dz, nuadt);
            for (i = 0; i < local_size; i++) {
            ...
            solve_helmholtz1d_u2(v, h, local_nx, local_ny, nz,
                                 nghost_x, nghost_y, nghost_z, dz, -nubdt,
                                 0.0, 0.0, bctype_v_bot, bctype_v_top);
            apply_bc_u2(v, local_nx, local_ny, nz, nghost_x, nghost_y, nghost_z,
                        xp, yv, dz, bc_v_bot, bc_v_top, bctype_v_bot, bctype_v_top);

            apply_bc_u2(c, local_nx, local_ny, nz, nghost_x, nghost_y, nghost_z,
                        xp, yp, dz, bc_c_bot, bc_c_top, bctype_c_bot, bctype_c_top);
            helmholtz1d_operator_u2(c, h, local_nx, local_ny, nz,
                                    nghost_x, nghost_y, nghost_z, dz, nuadt / prandtl);
            for (i = 0; i < local_size; i++) {
            ...
            solve_helmholtz1d_u2(c, h, local_nx, local_ny, nz,
                                 nghost_x, nghost_y, nghost_z, dz, -nubdt / prandtl,
            ...
            apply_bc_w2(bc, local_nx, local_ny, nz, nghost_x, nghost_y, nghost_z,
                        xp, yp, dz, bc_w_bot, bc_w_top, bctype_w_bot, bctype_w_top);
            helmholtz1d_operator_w2(bc, hbc, local_nx, local_ny, nz,
                                    nghost_x, nghost_y, nghost_z, dz, -nubdt);
            for (i = 0; i < local_size; i++) h[i] -= hbc[i];

            solve_helmholtz1d_w2(w, h, local_nx, local_ny, nz,
                                 nghost_x, nghost_y, nghost_z, dz, -nubdt,
                                 0.0, 0.0, bctype_w_bot, bctype_w_top);
            apply_bc_w2(w, local_nx, local_ny, nz, nghost_x, nghost_y, nghost_z,
                        xp, yp, dz, bc_w_bot, bc_w_top, bctype_w_bot, bctype_w_top);
...
void chanfast4(int p_row, int p_col,
               int nx, int ny, int nz, int it, int nt, int istat,
               int nghost_x, int nghost_y, int nghost_z,
               double lx, double ly, double lz,
               double dt, double want_cfl, int cflmode,
               ...
               double betg_x, double betg_y, double betg_z)
{
    ...
    for ( ; it < nt; it++) {
        ...
        for (step = 0; step < 3; step++) { // RK3 stepper
            ...
            add_laplacexy_operator_u4(u, fu, local_nx, local_ny, nz,
                                      nghost_x, nghost_y, nghost_z, dx, dy, nu);
            add_laplacexy_operator_u4(v, fv, local_nx, local_ny, nz,
                                      nghost_x, nghost_y, nghost_z, dx, dy, nu);
            add_laplacexy_operator_w4(w, fw, local_nx, local_ny, nz,
                                      nghost_x, nghost_y, nghost_z, dx, dy, nu);
            ...
            add_laplacexy_operator_u4(c, fc, local_nx, local_ny, nz,
                                      nghost_x, nghost_y, nghost_z, dx, dy, nu / prandtl);
            ...
            apply_bc_u4(bc, local_nx, local_ny, nz, nghost_x, nghost_y, nghost_z,
                        xu, yp, dz, bc_u_bot, bc_u_top, bctype_u_bot, bctype_u_top);
            helmholtz1d_operator_u4(bc, hbc, local_nx, local_ny, nz,
                                    nghost_x, nghost_y, nghost_z, dz, -nubdt);
            for (i = 0; i < local_size; i++) h[i] -= hbc[i];

            solve_helmholtz1d_u4(u, h, local_nx, local_ny, nz,
                                 nghost_x, nghost_y, nghost_z, dz, -nubdt,
                                 0.0, 0.0, bctype_u_bot, bctype_u_top);
            apply_bc_u4(u, local_nx, local_ny, nz, nghost_x, nghost_y, nghost_z,
                        xu, yp, dz, bc_u_bot, bc_u_top, bctype_u_bot, bctype_u_top);
            ...
            apply_bc_u4(v, local_nx, local_ny, nz, nghost_x, nghost_y, nghost_z,
                        xp, yv, dz, bc_v_bot, bc_v_top, bctype_v_bot, bctype_v_top);
            helmholtz1d_operator_u4(v, h, local_nx, local_ny, nz,
                                    nghost_x, nghost_y, nghost_z, dz, nuadt);
            for (i = 0; i < local_size; i++) {
                h[i] += gamdt * fv[i] + zetdt * gv[i];
            }
            ...
            solve_helmholtz1d_u4(v, h, local_nx, local_ny, nz,
                                 nghost_x, nghost_y, nghost_z, dz, -nubdt,
                                 0.0, 0.0, bctype_v_bot, bctype_v_top);
            apply_bc_u4(v, local_nx, local_ny, nz, nghost_x, nghost_y, nghost_z,
                        xp, yv, dz, bc_v_bot, bc_v_top, bctype_v_bot, bctype_v_top);
            ...
            apply_bc_u4(c, local_nx, local_ny, nz, nghost_x, nghost_y, nghost_z,
                        xp, yp, dz, bc_c_bot, bc_c_top, bctype_c_bot, bctype_c_top);
            helmholtz1d_operator_u4(c, h, local_nx, local_ny, nz,
                                    nghost_x, nghost_y, nghost_z, dz, nuadt / prandtl);
            for (i = 0; i < local_size; i++) {
                h[i] += gamdt * fc[i] + zetdt * gc[i];
            }
            ...
            solve_helmholtz1d_u4(c, h, local_nx, local_ny, nz,
                                 nghost_x, nghost_y, nghost_z, dz, -nubdt / prandtl,
                                 0.0, 0.0, bctype_c_bot, bctype_c_top);
            apply_bc_u4(c, local_nx, local_ny, nz, nghost_x, nghost_y, nghost_z,
                        xp, yp, dz, bc_c_bot, bc_c_top, bctype_c_bot, bctype_c_top);
            ...
            apply_bc_w4(bc, local_nx, local_ny, nz, nghost_x, nghost_y, nghost_z,
                        xp, yp, dz, bc_w_bot, bc_w_top, bctype_w_bot, bctype_w_top);
            helmholtz1d_operator_w4(bc, hbc, local_nx, local_ny, nz,
                                    nghost_x, nghost_y, nghost_z, dz, -nubdt);
            for (i = 0; i < local_size; i++) h[i] -= hbc[i];

            solve_helmholtz1d_w4(w, h, local_nx, local_ny, nz,
                                 nghost_x, nghost_y, nghost_z, dz, -nubdt,
                                 0.0, 0.0, bctype_w_bot, bctype_w_top);
            apply_bc_w4(w, local_nx, local_ny, nz, nghost_x, nghost_y, nghost_z,
                        xp, yp, dz, bc_w_bot, bc_w_top, bctype_w_bot, bctype_w_top);
